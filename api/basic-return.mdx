...
description: "BasicReturn is the base Pydantic model for unified Python function returns. Documents the ok and error fields and the to_dict() serialization method."
---
